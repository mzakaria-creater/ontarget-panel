...
const ALL_PAGES = [...DIRECT, { to: '/telegram', icon: '🤖', ar: 'Telegram', en: 'Telegram' }, { to: '/recovery', icon: '⚡', ar: 'الاسترجاع', en: 'Recovery' }, { to: '/settlement', icon: '💼', ar: 'التسويات', en: 'Settlement' }, { to: '/blacklist', icon: '🚫', ar: 'القائمة السوداء', en: 'Blacklist' }, { to: '/report', icon: '📑', ar: 'التقرير', en: 'Report' }, { to: '/analytics', icon: '📈', ar: 'التحليلات', en: 'Analytics' }, { to: '/users', icon: '👥', ar: 'المستخدمون', en: 'Users' }]
