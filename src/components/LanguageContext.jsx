...
Object.assign(TRANSLATIONS, {
  'غرفة المراقبة الحية': 'Live Control Room', 'رسائل SMS حية': 'Live SMS', 'معاملات حية': 'Live Transactions', 'مطابقة تلقائية': 'Automatic Matches', 'آخر المعاملات': 'Recent Transactions', 'تشغيل عاجل — فحص فوري وأسرع': 'Urgent Run — Fast Scan', 'إيقاف Turbo': 'Stop Turbo', 'صحة النظام والأتمتة': 'System & Automation Health', 'مراقبة Backend وSupabase وBrowser Worker': 'Backend, Supabase & Browser Worker health', 'محافظ Maven الحية': 'Live Maven Wallets', 'تقرير SMS والمعاملات لكل محفظة': 'SMS & Transaction Report by Wallet', 'إجمالي SMS': 'Total SMS', 'إجمالي SMS للمحافظ': 'Wallet SMS Report', 'مراقبة المحافظ على الهواتف': 'Wallet Phone Monitor', 'كل محفظة مرتبطة بالبنك والجهاز والشبكة': 'Every wallet linked to bank, device and network', 'داخل اليوم': 'In today', 'خارج اليوم': 'Out today', 'داخل الشهر': 'In this month', 'خارج الشهر': 'Out this month', 'الرصيد الحالي': 'Current balance', 'فرق الرصيد': 'Balance difference', 'اضغط على أي صف للتفاصيل': 'Click any row for details', 'تفاصيل المحفظة': 'Wallet details', 'مقبولة النهاردة': 'Paid today', 'مرفوضة النهاردة': 'Declined today', 'معلّقة الآن': 'Pending now', 'Jobs شغالة': 'Running jobs', 'Jobs معلقة': 'Pending jobs', 'Jobs فاشلة': 'Failed jobs', 'آخر فحص': 'Last check', 'مفعّلة': 'Enabled', 'متوقفة': 'Disabled', 'متصل': 'Connected', 'خطأ اتصال': 'Connection error', 'محافظ Maven': 'Maven Wallets', 'تقرير SMS للمحافظ': 'Wallet SMS Report', 'صحة النظام': 'System Health', 'مراقبة المحافظ': 'Wallet Monitor', 'هواتف المحافظ': 'Wallet Phones', 'TV shortcuts': 'اختصارات TV', 'Wallet Phone': 'هاتف المحافظ', 'Wallet SMS Report': 'تقرير SMS للمحافظ', 'System Health': 'صحة النظام', 'Maven Wallets': 'محافظ Maven',
})
