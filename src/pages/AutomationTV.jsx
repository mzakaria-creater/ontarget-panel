...
export default function AutomationTV() {
  ...
  const freshTxIds = useFreshIds(txRows, 'tx_id')
  const freshSmsIds = useFreshIds(smsRows, 'id')
  const freshJobIds = useFreshIds(jobRows, 'id')
  const stats = useMemo(() => {
